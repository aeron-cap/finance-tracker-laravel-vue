                    ...
                    <form @submit.prevent="accept_action" class="space-y-6">
                        ...
                        <div class="bg-gray-50 dark:bg-gray-800 p-4 rounded-lg">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div>
                                    <label for="status-select" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Select Budget</label>
                                    <select 
                                        id="status-select" 
...
watch(() => props.show, (newValue) => {
  if (!newValue || props.id == null) {
    ...
    income_data.value.status_id = null,
...
function get_budget_types() {
  try {
    axios.post('api/budget_types', {type: 'Income'}).then((response) => {
      income_budget_types.value = response.data.budget_types || [];
    })
  }catch (error) {}
}
...
async function get_budgets() {
  try {
    axios.post('api/budgets').then((response) => {
      budgets.value = response.data.budget_types || [];
    })
  }catch (error) {}
}
